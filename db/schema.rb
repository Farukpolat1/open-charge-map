...
ActiveRecord::Schema[8.1].define(version: 2026_07_22_110136) do
  ...
  create_table "ocm_stations", force: :cascade do |t|
    ...
    t.string "town"
    t.datetime "updated_at", null: false
    t.index ["ocm_id"], name: "index_ocm_stations_on_ocm_id", unique: true
  end
